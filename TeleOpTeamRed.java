...
@TeleOp (name= "TeleOpTeamRed", group= "Linear Opmode")
public class TeleOpTeamRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        waitForStart();
            while (opModeIsActive()) {
                ...
                //If X is held go forward at full speed
                if (gamepad1.x) {
